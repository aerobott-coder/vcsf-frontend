...
export function WhyTrustUs() {
    ...
    return (
        <section id="why-trust-us" className="py-14 sm:py-24 bg-gray-50 overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10 sm:gap-16">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2
                                className="text-[#0F2C59] text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-5 sm:mb-8 leading-tight"
                            ...
                            <div className="space-y-3 sm:space-y-4 mb-7 sm:mb-10">
                                {checkPoints.map((point, index) => (
                                    ...
                                    >
                                        <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-[#D4AF37] flex-shrink-0" />
                    ...
                    <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        {trustPoints.map((item, index) => (
                            <motion.div
                                ...
                                className={`bg-white p-5 sm:p-8 rounded-3xl shadow-lg border-b-4 border-[#D4AF37] hover:-translate-y-2 transition-transform duration-300 ${
                                    index === 2 ? "sm:col-span-2" : ""
                                }`}
                            >
                                <div className="w-12 sm:w-16 h-12 sm:h-16 bg-[#F9F7F2] rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-inner">
                                    {item.icon}
                                </div>
